...
interface BulkCreateSetsDialogProps {
  open: boolean
  ...
  setBulkNegativeMarks: (v: string) => void
  onSave: () => void
  saving: boolean
}

export function BulkCreateSetsDialog({
  ...
  bulkDuration, setBulkDuration, bulkMarksPerQ, setBulkMarksPerQ,
  bulkNegativeMarks, setBulkNegativeMarks, onSave, saving
}: BulkCreateSetsDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            একসাথে একাধিক এক্সাম সেট তৈরি করুন। সেটগুলো ক্রমানুসারে তারিখ অনুযায়ী তৈরি হবে।
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div className="space-y-2">
              ...
              <Input type="number" step="0.25" value={bulkNegativeMarks} onChange={(e) => setBulkNegativeMarks(e.target.value)} />
            </div>
          </div>
        </div>
